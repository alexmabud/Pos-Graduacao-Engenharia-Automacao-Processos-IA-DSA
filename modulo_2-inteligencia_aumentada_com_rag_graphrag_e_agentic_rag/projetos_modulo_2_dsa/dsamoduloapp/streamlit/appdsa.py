...
def main():
    ...
    st.set_page_config(page_title="DSA Projeto 1", page_icon=":100:", layout="wide")

    # Barra lateral para configurações e informações da app
    st.sidebar.title("Data Science Academy")
    st.sidebar.subheader("Projeto 1")
    st.sidebar.write("Deploy e Operacionalização de Aplicação de IA Generativa com LLM e RAG")
    st.sidebar.markdown("---")

    # Cabeçalho principal
    st.title("Assistente de IA da Data Science Academy")
