...
import hashlib
import requests
from app.dsaconnection import postgre_connection
...
def dsa_captura_user_input(docId, userQuery, result, llmScore, responseTime, hit_rate, mrr):
