...
# Verifica se há conteúdo válido antes de salvar
if response.strip():
    with open("resultados.txt", "w", encoding="utf-8") as arquivo:
        arquivo.write("=== RELATÓRIO DE INTELIGÊNCIA DE MERCADO ===\n\n")
        arquivo.write(response)

    print("[DSA-INFO] Os resultados foram salvos com sucesso em 'resultados.txt'.")
else:
    print("[DSA-ERRO] A resposta do agente veio vazia, apesar de ter sido exibida no terminal.")
